  ...
  <Box>
    <Box sx={{height:'200px'}}>
      ...
      <Modal
        ...
        <form action="php/asistenciaCeremonia.php" method="post" onSubmit={handleSubmit} className="form" id="form">
          ...
          <TextField id="codigo" className="form-input" name="codigo" label="Ingrese su código de confirmación" variant="filled" fullWidth  margin="normal"/>
